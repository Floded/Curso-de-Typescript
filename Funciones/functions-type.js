...
(() => {
    ...
    let myFunction; //* esta variable ahora es de tipo funcion. Dependiendo de la funcion que le asignemos seran los tipos de argumentos que le pasemos ej: let myFunction: (y: number, b: number) => number: esta hace referencia a la fn addNumbers donde los argumentos son "number" y el retorno es de tipo "number";
    //!   myFunction = 10;
